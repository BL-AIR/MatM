...
// Switch FROM_EMAIL once matm.com.au is verified in Resend:
//   Production:  'Madeleine at the Movies <noreply@matm.com.au>'
//   Testing:     'Madeleine at the Movies <onboarding@resend.dev>'
const FROM_EMAIL = 'Madeleine at the Movies <onboarding@resend.dev>';
...
export default {
  async fetch(request, env) {
    ...
    // ── Extract excerpt from subtitle cues ──────────────────────────────────
    let excerpt = '';
...
function buildEmail({ chapter, episode, excerpt, deepLink }) {
...
<body style="font-family:Georgia,serif;max-width:580px;margin:0 auto;padding:28px 24px;color:#222;background:#fff;">
  ...
  <p style="font-size:14px;color:#555;margin:0 0 20px;">Episode ${episode} &nbsp;&middot;&nbsp; <strong style="color:#333;">${chapter}</strong></p>
  ...
  <p style="font-size:12px;color:#bbb;font-style:italic;line-height:1.6;margin:0 0 20px;">
    This transcript was produced using an AI transcription tool. Please check carefully for accuracy, spelling, and proper nouns before publication.
  </p>
...
---
Madeleine at the Movies · Golden Days Radio 95.7FM Melbourne · matm.com.au`;
