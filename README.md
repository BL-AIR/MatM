...
To add a photo of Madeleine, replace the `<div class="about-portrait">` placeholder with:

```html
<img src="madeleine.jpg" alt="Madeleine Swain" />
```

and add `madeleine.jpg` to the repo root.
